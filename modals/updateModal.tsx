...
import { UpdateIncomeOrBills } from "@/backend/sql_queries/IncomeAndBillsTable";
import { useAuth } from "@/components/authContext";
import React, { useState } from "react";
import { Button, Modal, StyleSheet, Text, TextInput, View } from "react-native";
export default function UpdateMondals({
  tableName,
  open,
  setOpen,
  setUpdate,
  ...
  const handleSubmit = async () => {
    ...
    setData(
      await UpdateIncomeOrBills(user.id, tableName, rowId, {
        name: name,
        pay_date: parsedDate,
        amount: amount,
      }),
